...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <h2 class="card-header pt-3 pb-2">設施介紹  - 編輯
                </h2>
                ...
                <div class="card-body">
                    <form method="POST" action="{{route('facility.update',['id'=>$facility->id])}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row py-2">
                            ...
                            <div class="col-sm-10">
                                <input Vlue={{$facility->title}} type="text" class="form-control" id="title" name="title" value="{{$facility->title}}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row py-2">
                            ...
                            <div class="col-sm-10">
                                <img src="{{Storage::url($facility->image_url)}}" alt="" width="200">
                        ...
                        <div class="form-group row py-2">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" name="content" 
                                        id="content" rows="5" required>{{$facility->content}}</textarea>
                            </div>
                        </div>
                        <div class="form-group row py-2">
