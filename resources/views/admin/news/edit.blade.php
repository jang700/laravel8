...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <h2 class="card-header pt-3 pb-2">最新消息 - 編輯
                </h2>
                ...
                <div class="card-body">
                    <form method="POST" action="{{route('news.update',['id' => $news->id])}} ">
                        ...
                        <div class="form-group row py-2">
                            ...
                            <div class="col-sm-10">
                                <input Vlue={{$news->title}} type="text" class="form-control" id="title" name="title" value="{{$news->title}}" required>
                            </div>
                        </div>
                        <div class="form-group row py-2">
                            <label for="date" class="col-sm-2 col-form-label">日期</label>
                            <div class="col-sm-10">
                                <input Vlue={{$news->date}} type="date" class="form-control" id="date" name="date" value="{{$news->date}}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row py-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="img" 
                                        name="image_url" value="{{$news->image_url}}" required>
                            </div>
                        </div>
                        <div class="form-group row py-2">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" name="content" 
                                        id="content" rows="5" required>{{$news->content}}</textarea>
                            </div>
                        </div>
                        <div class="form-group row py-2">
