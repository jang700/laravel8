    ...
    <div class="container">
        ...
        <div class="row p-3">
            <div class="col-6">
                <div class="row">
                    <div class="col-6 p-1">
                        <img src="https://placeholder.pics/svg/500x300" class="img-fluid"
                            alt="Responsive image">
                    </div>
                    <div class="col-6 p-1">
                        <img src="https://placeholder.pics/svg/501x301" class="img-fluid"
                            alt="Responsive image">
                    </div>
                    <div class="col p-1">
                        <img src="https://placeholder.pics/svg/600x360" class="img-fluid"
                            alt="Responsive image">
                    </div>
                </div>
            </div>
            <div class="col-6">
                <div class="row">
                    <div class="col-12 p-1">
                        <img src="https://placeholder.pics/svg/601x361" class="img-fluid"
                            alt="Responsive image">
                    </div>
                    <div class="col p-1">
                        <img src="https://placeholder.pics/svg/502x302" class="img-fluid"
                            alt="Responsive image">
                    </div>
                    <div class="col p-1">
                        <img src="https://placeholder.pics/svg/503x303" class="img-fluid"
                            alt="Responsive image">
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-6 col-12">
                    <form class="card-body">
                        ...
                        <div class="d-flex">
                            <div class="d-flex align-items-center">
                                ...
                                <label class="mx-1 color-label" for="white"
                                    ...
                                    <input class="color-radio" type="radio" id="white" name="color"
                                        value="white" aria-label="...">
                                </label>
                                <label class="mr-1 color-label" for="blue"
                                    style="background-color: rgb(69, 77, 192);">
                                    <input class="color-radio" type="radio" id="blue" name="color" value="blue"
                                        aria-label="...">
                                </label>
                                <label class="mr-1 color-label" for="black"
                                    style="background-color: rgb(36, 35, 35);">
                                    <input class="color-radio" type="radio" id="black" name="color"
                                        value="black" aria-label="...">
                                </label>
                            </div>
                        ...
                        <div class="d-flex">
                            ...
                            <button type="button" class="btn ml-3 like-btn"><i
                                    class="fab fa-gratipay"></i></button>
                        </div>
                    </form>
                </div>
                ...
                <form action="{{asset('/contact')}}" method="POST">
                    ...
                    <div class="my-4">
                        ...
                        <span class="invalid-feedback" role="alert">
                                <strong class="text-deanger">{{ $message }}</strong>
                        </span>
                         @enderror
